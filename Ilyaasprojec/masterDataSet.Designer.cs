...
namespace Ilyaasprojec.masterDataSetTableAdapters {
...
SELECT product_id, product_name, description, price, quantity_in_stock, supplier_id FROM Products WHERE (product_id = @product_id)";
        ...
        public virtual int Fill(masterDataSet.ProductsDataTable dataTable) {
        ...
        public virtual masterDataSet.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet.ProductsDataTable dataTable = new masterDataSet.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet.ProductsDataTable dataTable) {
