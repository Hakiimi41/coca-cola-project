...
namespace Ilyaasprojec {
    ...
    public partial class inventoryManagementDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(int customer_id, string customer_name) {
...
namespace Ilyaasprojec.inventoryManagementDataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([customer_id], [customer_name]) VALUES (@customer_" +
                "id, @customer_name);\r\nSELECT customer_id, customer_name FROM Customers WHERE (cu" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [customer_id] = @customer_id, [customer_name] = @customer_name WHERE (([customer_id] = @Original_customer_id) AND ((@IsNull_customer_name = 1 AND [customer_name] IS NULL) OR ([customer_name] = @Original_customer_name)));
SELECT customer_id, customer_name FROM Customers WHERE (customer_id = @customer_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Ilyaasprojec.Properties.Settings.Default.inventoryManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT customer_id, customer_name FROM dbo.Customers";
        ...
        public virtual int Fill(inventoryManagementDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual inventoryManagementDataSet1.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            inventoryManagementDataSet1.CustomersDataTable dataTable = new inventoryManagementDataSet1.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(inventoryManagementDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual int Insert(int customer_id, string customer_name) {
        ...
        public virtual int Update(int customer_id, string customer_name, int Original_customer_id, string Original_customer_name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string customer_name, int Original_customer_id, string Original_customer_name) {
            return this.Update(Original_customer_id, customer_name, Original_customer_id, Original_customer_name);
        }
    }
