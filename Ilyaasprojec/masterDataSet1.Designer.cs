...
namespace Ilyaasprojec {
    ...
    public partial class masterDataSet1 : global::System.Data.DataSet {
        ...
        public partial class SuppliersDataTable : global::System.Data.TypedTableBase<SuppliersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SuppliersRow AddSuppliersRow(int supplier_id, string supplier_name, string contact_person, string phone_number, string email_address) {
        ...
        public partial class SuppliersRow : global::System.Data.DataRow {
            ...
            public string contact_person {
                get {
                    try {
                        return ((string)(this[this.tableSuppliers.contact_personColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableSuppliers.contact_personColumn] = value;
                }
            }
            ...
            public string email_address {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'email_address\' in table \'Suppliers\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool Iscontact_personNull() {
                return this.IsNull(this.tableSuppliers.contact_personColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Setcontact_personNull() {
                this[this.tableSuppliers.contact_personColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool Isemail_addressNull() {
                return this.IsNull(this.tableSuppliers.email_addressColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Setemail_addressNull() {
                this[this.tableSuppliers.email_addressColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Ilyaasprojec.masterDataSet1TableAdapters {
    ...
    public partial class SuppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Suppliers] ([supplier_id], [supplier_name], [contact_person], [phone_number], [email_address]) VALUES (@supplier_id, @supplier_name, @contact_person, @phone_number, @email_address);
SELECT supplier_id, supplier_name, contact_person, phone_number, email_address FROM Suppliers WHERE (supplier_id = @supplier_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Suppliers] SET [supplier_id] = @supplier_id, [supplier_name] = @supplier_name, [contact_person] = @contact_person, [phone_number] = @phone_number, [email_address] = @email_address WHERE (([supplier_id] = @Original_supplier_id) AND ((@IsNull_supplier_name = 1 AND [supplier_name] IS NULL) OR ([supplier_name] = @Original_supplier_name)) AND ((@IsNull_contact_person = 1 AND [contact_person] IS NULL) OR ([contact_person] = @Original_contact_person)) AND ((@IsNull_phone_number = 1 AND [phone_number] IS NULL) OR ([phone_number] = @Original_phone_number)) AND ((@IsNull_email_address = 1 AND [email_address] IS NULL) OR ([email_address] = @Original_email_address)));
SELECT supplier_id, supplier_name, contact_person, phone_number, email_address FROM Suppliers WHERE (supplier_id = @supplier_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT supplier_id, supplier_name, contact_person, phone_number, email_address FR" +
                "OM dbo.Suppliers";
        ...
        public virtual int Fill(masterDataSet1.SuppliersDataTable dataTable) {
        ...
        public virtual masterDataSet1.SuppliersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet1.SuppliersDataTable dataTable = new masterDataSet1.SuppliersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet1.SuppliersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_supplier_id, string Original_supplier_name, string Original_contact_person, string Original_phone_number, string Original_email_address) {
        ...
        public virtual int Insert(int supplier_id, string supplier_name, string contact_person, string phone_number, string email_address) {
        ...
        public virtual int Update(int supplier_id, string supplier_name, string contact_person, string phone_number, string email_address, int Original_supplier_id, string Original_supplier_name, string Original_contact_person, string Original_phone_number, string Original_email_address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string supplier_name, string contact_person, string phone_number, string email_address, int Original_supplier_id, string Original_supplier_name, string Original_contact_person, string Original_phone_number, string Original_email_address) {
            return this.Update(Original_supplier_id, supplier_name, contact_person, phone_number, email_address, Original_supplier_id, Original_supplier_name, Original_contact_person, Original_phone_number, Original_email_address);
        }
    }
