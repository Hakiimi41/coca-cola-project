...
namespace Ilyaasprojec.masterDataSet4TableAdapters {
...
SELECT order_id, order_date, customer_id FROM Orders WHERE (order_id = @order_id)";
        ...
        public virtual int Fill(masterDataSet4.OrdersDataTable dataTable) {
        ...
        public virtual masterDataSet4.OrdersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet4.OrdersDataTable dataTable = new masterDataSet4.OrdersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet4.OrdersDataTable dataTable) {
