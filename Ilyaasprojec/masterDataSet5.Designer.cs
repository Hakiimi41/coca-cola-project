...
namespace Ilyaasprojec {
    ...
    public partial class masterDataSet5 : global::System.Data.DataSet {
        ...
        public partial class registrationDataTable : global::System.Data.TypedTableBase<registrationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public registrationRow AddregistrationRow(string fistname, string lastname, string username, string password, string email, int phone, string address) {
        ...
        public partial class registrationRow : global::System.Data.DataRow {
            ...
            public string fistname {
                get {
                    try {
                        return ((string)(this[this.tableregistration.fistnameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'fistname\' in table \'registration\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableregistration.fistnameColumn] = value;
                }
            }
            ...
            public bool IsfistnameNull() {
                return this.IsNull(this.tableregistration.fistnameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetfistnameNull() {
                this[this.tableregistration.fistnameColumn] = global::System.Convert.DBNull;
            }
...
namespace Ilyaasprojec.masterDataSet5TableAdapters {
    ...
    public partial class registrationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[registration] ([fistname], [lastname], [username], [password], [email], [phone], [address]) VALUES (@fistname, @lastname, @username, @password, @email, @phone, @address);
SELECT id, fistname, lastname, username, password, email, phone, address FROM registration WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[registration] SET [fistname] = @fistname, [lastname] = @lastname, [username] = @username, [password] = @password, [email] = @email, [phone] = @phone, [address] = @address WHERE (([id] = @Original_id) AND ((@IsNull_fistname = 1 AND [fistname] IS NULL) OR ([fistname] = @Original_fistname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)));
SELECT id, fistname, lastname, username, password, email, phone, address FROM registration WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, fistname, lastname, username, password, email, phone, address FROM dbo" +
                ".registration";
        ...
        public virtual int Fill(masterDataSet5.registrationDataTable dataTable) {
        ...
        public virtual masterDataSet5.registrationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet5.registrationDataTable dataTable = new masterDataSet5.registrationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet5.registrationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_fistname, string Original_lastname, string Original_username, string Original_password, string Original_email, global::System.Nullable<int> Original_phone, string Original_address) {
        ...
        public virtual int Insert(string fistname, string lastname, string username, string password, string email, global::System.Nullable<int> phone, string address) {
            if ((fistname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fistname, string lastname, string username, string password, string email, global::System.Nullable<int> phone, string address, int Original_id, string Original_fistname, string Original_lastname, string Original_username, string Original_password, string Original_email, global::System.Nullable<int> Original_phone, string Original_address) {
            return this.Update(fistname, lastname, username, password, email, phone, address, Original_id, Original_fistname, Original_lastname, Original_username, Original_password, Original_email, Original_phone, Original_address, Original_id);
        }
    }
